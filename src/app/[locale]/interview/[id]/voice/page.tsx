  ...
  async function handleRecordingComplete(blob: Blob, _durationMs: number) {
    ...
    try {
          ...
          try {
            ...
            switch (eventName) {
              case "candidate": {
                ...
                setProcessingStep(t("interviewerThinking"));
                break;
              }
              ...
              case "sentence": {
                ...
                setProcessingStep(t("generatingVoice"));
                break;
              }
              ...
              case "error": {
                ...
                if (!hasReceivedSentencesRef.current) {
                  ...
                  setError(parsed.message || t("streamingError"));
                  setProcessing(false);
                  setProcessingStep("");
                }
                break;
      ...
      if (!hasReceivedSentencesRef.current) {
        ...
        setError(err instanceof Error ? err.message : t("streamingError"));
        setProcessing(false);
        setProcessingStep("");
      }
    } finally {
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 p-4 dark:bg-zinc-950">
        <div className="text-center">
          <h1 className="mb-2 text-xl font-semibold text-zinc-900 dark:text-zinc-50">
            {data.position?.title || t("interviewer")}
          </h1>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="text-sm text-zinc-500 dark:text-zinc-400">
                {isComplete ? (
                  ...
                  <span>
                    {t("turnCounter", {
                      current: data?.session.currentTurn ?? 0,
                      max: data?.session.maxTurns ?? 8,
                    })}
                  </span>
                )}
              </div>
