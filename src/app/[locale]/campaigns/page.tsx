          ...
          <table className="w-full text-sm">
            <thead className="bg-zinc-50 dark:bg-zinc-800">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-medium text-zinc-700 dark:text-zinc-300">{t("positions")}</th>
                <th className="px-4 py-3 text-left font-medium text-zinc-700 dark:text-zinc-300">{t("sessions")}</th>
                <th className="px-4 py-3 text-left font-medium text-zinc-700 dark:text-zinc-300">{t("dates")}</th>
              ...
              {campaigns.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-4 py-8 text-center text-zinc-500 dark:text-zinc-400">
                    {t("noCampaigns")}{" "}
                    <Link href="/campaigns/new" className="underline">{t("createOne")}</Link>.
                  </td>
                </tr>
              ) : (
                campaigns.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-3 grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <span className="text-zinc-500 dark:text-zinc-400">{t("positions")}:</span>{" "}
                      <span className="font-medium text-zinc-900 dark:text-zinc-50">{posCount}</span>
                    </div>
                    <div>
                      <span className="text-zinc-500 dark:text-zinc-400">{t("sessions")}:</span>{" "}
