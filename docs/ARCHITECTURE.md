...
- **Backend architecture** is documented in [adaptive-interview-api/docs/ARCHITECTURE.md](https://github.com/vdung2k6-myna/adaptive-interview-api/blob/main/docs/ARCHITECTURE.md)
